...
4. Для работы с heroku Вам необходимо докупить возможность работы с SSL. Об этом недвусмысленно намекает надпис "Upgrade to paid dynos to configure Heroku SSL" в настройках.
